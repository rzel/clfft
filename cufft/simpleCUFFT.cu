...
void runTest(int argc, char** argv) 
{
    ...
    cufftSafeCall(cufftPlan1d(&plan, N, CUFFT_C2C, SIGNAL_SIZE / N));
...
//    cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_filter_kernel, (cufftComplex *)d_filter_kernel, CUFFT_FORWARD));
    ...
    dim3 blocks(SIGNAL_SIZE / 256);
    // Multiply the coefficients together and normalize the result
    ComplexPointwiseMulAndScale<<<blocks, 256>>>(d_signal, d_filter_kernel, new_size, 1.0f / new_size);
